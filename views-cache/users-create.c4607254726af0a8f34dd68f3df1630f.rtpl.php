...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    <!-- Caminho para retornar para a tela principal de administração -->
    <li><a href="/admin"><i class="fa fa-dashboard"></i> Home</a></li>
    <!-- Caminho para a tela de Usuários -->
    <li><a href="/admin/users">Usuários</a></li>
    <!-- caminho para a tela de criação de usuários -->
...
<section class="content">
  ...
  <div class="row">
  	<div class="col-md-12">
        ...
        <!-- /.box-header -->
        <!-- form start -->
        <!-- inserção de dados no banco, após preencher os campos -->
