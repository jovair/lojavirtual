									...
									<div class="woocommerce-billing-fields">
										...
										<div id="order_review" style="position: relative;">
											...
											<p id="billing_state_field" class="form-row form-row-first address-field validate-state" data-o_class="form-row form-row-first address-field validate-state">
												...
												<label class="" for="method-pagseguro"><img style="height:64px;" src="/res/site/img/logo-pagseguro.png" style="float:left; margin: 30px;"></label>
											</p>
											<p id="billing_state_field" class="form-row form-row-first address-field validate-state" data-o_class="form-row form-row-first address-field validate-state">
												<input type="radio" checked="checked" id="method-paypal" name="payment-method" placeholder="País" value="2">
												<label class="" for="method-paypal"><img style="height:64px;" src="/res/site/img/logo-paypal.png" style="float:left; margin: 30px;"></label>
											</p>
											<div id="payment">
